						...
						<div class="apwelcome-column-wrap">
							...
							<div class="apwelcome-column col-doc">
								<div>
									...
									<a href="<?php echo esc_url('https://accesspressthemes.com/support/')?>" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'vmagazine-lite' ); ?></span></a>
			...
			public function welcome_screen() {
				...
				// Get Plugin Info
					...
					public function plugin_deactivation_callback() {
						if ( ! current_user_can('activate_plugins') ) {
							wp_die( esc_html__( 'Sorry, you are not allowed to deactivate plugins on this site.', 'vmagazine-lite' ) );
						}
